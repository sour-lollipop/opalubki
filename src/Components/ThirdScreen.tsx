...
Размеры опалубок: 1,25м х 1м / 1м х 1,5м"
        right={false}
        image={acc2}
      />
...
Стандартная балка для опалубки имеет размер 80х40х200, где 80 мм — это ширина полки, 40 мм — толщина полки, 200 мм — высота всего двутавра (для H20).`,
    right: true,
    image: acc6,
  },
  {
...
Наша фанера 1 сорта, Россия. Произведена из березы. Что говорит о прочности материалы и его много кратном использовании (до 5-7 циклов).
`,
    right: false,
    image: acc9,
  },
